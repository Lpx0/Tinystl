...
namespace TinySTL {
	namespace StringTest {
		...
		void testCase11() {
			...
			s1.insert(s1.size() - 1, "linpeixian", 3);
			s2.insert(s2.size() - 1, "linpeixian", 3);
			assert(TinySTL::Test::container_equal(s1, s2));
		...
		void testCase16() {
			stdStr s1("linpeixian"), t1("I Love C++");
			tsStr s2("linpeixian"), t2("I Love C++");
